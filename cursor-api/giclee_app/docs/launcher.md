...
**LC-3K component order persistence adapter:** `launcher_drag_component_persistence.py` izoluje widoczny reorder, zachowanie ukrytych slotów, reindeksację sort_key oraz zapis layoutu. DragDropCategoryGicleeApp zachowuje aktywną sekcję, resolve widocznych komponentów i UI orchestration.
