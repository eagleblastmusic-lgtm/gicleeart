...
def _default_media_settings(asset_id: str) -> dict[str, Any]:
    return {
        ...
        "scroll_intro_pin_vh": 45,
        "scroll_intro_fade_start_vh": 45,
        "scroll_outro_text": "",
        "scroll_outro_appear_percent": 95,
        "scroll_outro_pin_vh": 60,
        ...
        "scroll_background_parallax": False,
    ...
    return (
        ...
        _field(
            ...
            hint=(
                ...
                "nie wcześniej niż kończy się przypięcie."
            ),
        ),
        _field(
            section_key,
        ...
        _field(
            ...
            step=1,
            unit="%",
            hint="0% = start filmu, 100% = końcowa klatka.",
        ),
        _field(
            section_key,
            "scroll_outro_pin_vh",
            ...
            step=5,
            unit="vh",
            hint="Jak długo tekst końcowy pozostaje przypięty po pojawieniu.",
        ),
        _field(
            section_key,
