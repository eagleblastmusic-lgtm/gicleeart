...
def _cmd_collect_pairs(args: argparse.Namespace) -> int:
    ...
    print(f"Zebrano {len(manifests)} par -> {args.output_dir}/index.json")
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    col.add_argument("--input-dir", required=True)
    col.add_argument("--output-dir", required=True)
    ...
    cid.add_argument("--output-dir", required=True)
    ...
    cal.add_argument("pairs_dir", type=Path)
