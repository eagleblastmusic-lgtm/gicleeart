"""Poprawka tytulow: Zagrody wiejskie przy traktacie (Jacob Van Ruisdael)."""
...
PRODUCT_ID = 15611319779676
ARTIST = "Jacob Van Ruisdael"
OLD_PL_TITLES = (
    "Wiejskie domy przy gościńcu",
    "Zagrody wiejskie przy traktacie",
)
NEW_PL_TITLE = format_title_alternative_parenthetical(
    "Zagrody wiejskie przy traktacie (lub Domy wiejskie przy gościńcu)",
    "pl",
)
ORIGINAL_TITLE = "Boerderijen aan een grote weg"
ENGLISH_TITLE = format_title_alternative_parenthetical(
    "Farmhouses on a High Road (or Farmhouses and a Tower)",
    "en",
)
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": "Bauernhäuser an einer großen Straße",
    "fr": "Fermes sur une grande route",
    "es": "Granjas en un gran camino",
    "nl": ORIGINAL_TITLE,
    "it": "Case coloniche su una grande strada",
}
ALT_EN_TITLE = "Farmhouses on a High Road"
