"""Poprawka tytulow: Kuter pilotowy nr 3 powracajacy do brzegu (Henry King Taylor)."""
...
NEW_PL_TITLE = "Kuter pilotowy nr 3 powracający do brzegu"
ORIGINAL_TITLE = "Pilot cutter no. 3 heading back inshore"
ENGLISH_TITLE = (
