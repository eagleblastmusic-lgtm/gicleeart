"""Poprawka tytulow: U bram wiecznosci (Vincent Van Gogh)."""
...
PRODUCT_ID = 15611332886876
ARTIST = "Vincent Van Gogh"
OLD_PL_TITLES = (
    "U bram wieczności",
)
NEW_PL_TITLE = "U bram wieczności (lub Złamany życiem/Stary człowiek w żałobie)"
ORIGINAL_TITLE = "Op de drempel van de eeuwigheid (of Oude man met verdriet)"
ENGLISH_TITLE = "At Eternity's Gate (or Sorrowing Old Man)"
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": "An der Schwelle zur Ewigkeit (oder Trauernder alter Mann)",
    "fr": "À la porte de l'éternité (ou Vieillard au désespoir)",
    "es": "En el umbral de la eternidad (o Anciano apenado)",
    "nl": ORIGINAL_TITLE,
    "it": "Sulla soglia dell'eternità (o Vecchio dolorante)",
}
ALT_EN_TITLE = "At Eternity's Gate"
