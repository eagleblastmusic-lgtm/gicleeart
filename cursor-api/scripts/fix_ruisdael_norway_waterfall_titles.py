"""Poprawka tytulow: Norweski krajobraz z wodospadem (Jacob Van Ruisdael)."""
...
PRODUCT_ID = 15611319943516
ARTIST = "Jacob Van Ruisdael"
OLD_PL_TITLES = (
    "Norweski pejzaż z wodospadem",
    "Norweski krajobraz z wodospadem",
)
NEW_PL_TITLE = (
    "Norweski krajobraz z wodospadem "
    "(lub Wodospad w górzystym krajobrazie z zamkiem)"
)
ORIGINAL_TITLE = "Berglandschap met waterval"
ENGLISH_TITLE = (
    "Norwegian Landscape with Waterfall "
    "(or A Landscape with a Waterfall and a Castle on a Hill)"
)
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": "Berglandschaft mit Wasserfall",
    "fr": "Paysage montagneux avec cascade",
    "es": "Paisaje montañoso con cascada",
    "nl": ORIGINAL_TITLE,
    "it": "Paesaggio montano con cascata",
}
ALT_EN_TITLE = "Norwegian Landscape with Waterfall"
