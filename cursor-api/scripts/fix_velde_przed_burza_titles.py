"""Poprawka tytulow: Przed burzą (Willem Velde)."""
...
PRODUCT_ID = 15611427553628
ARTIST = "Willem Velde"
NEW_PL_TITLE = "Przed burzą"
ORIGINAL_TITLE = "Voor de storm"
ENGLISH_TITLE = "Before the Storm"
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": "Vor dem Sturm",
    "fr": "Avant la tempête",
    "es": "Antes de la tormenta",
    "nl": ORIGINAL_TITLE,
    "it": "Prima della tempesta",
}
