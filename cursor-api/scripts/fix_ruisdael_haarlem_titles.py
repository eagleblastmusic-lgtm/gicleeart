"""Poprawka tytulow: Widok Haarlemu z bielnikami (Jacob Van Ruisdael)."""
...
PRODUCT_ID = 15611320566108
ARTIST = "Jacob Van Ruisdael"
OLD_PL_TITLES = (
    "Widok Haarlemu z polami do bielenia płótna",
    "Widok Haarlem z polami bielenia płótna",
)
NEW_PL_TITLE = "Widok Haarlemu z bielnikami (lub Widok na Haarlem z polami bielenia lnu)"
ORIGINAL_TITLE = "Gezicht op Haarlem met bleekvelden"
ENGLISH_TITLE = "View of Haarlem with Bleaching Fields (or View of Haarlem with Bleaching Grounds)"
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": "Die Bleichen bei Haarlem (oder Ansicht von Haarlem mit Bleichfeldern)",
    "fr": "Vue de Haarlem avec champs de blanchiment",
    "es": "Vista de Haarlem con campos de blanqueo",
    "nl": ORIGINAL_TITLE,
    "it": "Veduta di Haarlem con campi di candeggio",
}
ALT_EN_TITLE = "View of Haarlem with Bleaching Fields"
