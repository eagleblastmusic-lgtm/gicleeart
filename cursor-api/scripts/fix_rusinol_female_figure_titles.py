"""Poprawka tytulow: Kobieca figura (Santiago Rusinol)."""
...
OLD_PL_TITLES = ("Female Figure",)
NEW_PL_TITLE = "Kobieca figura"
ORIGINAL_TITLE = "Figura femenina"
ENGLISH_TITLE = "Female Figure"
