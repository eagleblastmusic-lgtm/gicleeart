"""Poprawka tytulow: Dobry Samarytanin (Vincent Van Gogh)."""
...
OLD_PL_TITLES = (
    "Miłosierny Samarytanin (wg Delacroix)",
...
ORIGINAL_TITLE = "De barmhartige Samaritaan (naar Delacroix)"
ENGLISH_TITLE = "The Good Samaritan (after Delacroix)"
