"""Poprawka tytulow: Dziewczyna z perłą (Johannes Vermeer)."""
...
PRODUCT_ID = 15611528806748
ARTIST = "Johannes Vermeer"
OLD_PL_TITLES = ("Dziewczyna z perłą",)
NEW_PL_TITLE = format_title_alternative_parenthetical(
    "Dziewczyna z perłą (lub Dziewczyna w turbanie)",
    "pl",
)
ORIGINAL_TITLE = "Meisje met de parel (of Meisje met de tulband)"
ENGLISH_TITLE = format_title_alternative_parenthetical(
    "Girl with a Pearl Earring (or Girl with a Turban)",
    "en",
)
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": format_title_alternative_parenthetical(
        "Das Mädchen mit dem Perlenohrring (oder Das Mädchen mit dem Tulban)",
        "de",
    ),
    ...
    "it": format_title_alternative_parenthetical(
        "Ragazza col turbante (o Ragazza con l'orecchino de perla)",
        "it",
    ),
}
ALT_EN_TITLE = "Girl with a Pearl Earring"
...
def _apply_locale_titles(body_html: str, loc: str) -> str:
    ...
    updated = body_html
    for old_orig in ("Meisje met de parel", ORIGINAL_TITLE):
