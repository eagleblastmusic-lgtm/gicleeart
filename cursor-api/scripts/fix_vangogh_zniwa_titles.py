"""Poprawka tytulow: Zniwa (Vincent Van Gogh)."""
...
PRODUCT_ID = 15611354087772
ARTIST = "Vincent Van Gogh"
OLD_PL_TITLES = (
    "Żniwa (rzadziej: Żniwa w La Crau lub Pola we wzgórzach)",
    "Żniwa (rzadziej: Żniwa w La Crau (lub Pola we wzgórzach))",
    "Tabor cygański pod Arles",
    "Żniwa",
)
NEW_PL_TITLE = "Żniwa (lub Żniwa w La Crau/Pola we wzgórzach)"
ORIGINAL_TITLE = "De oogst (of De oogst in de Provence)"
ENGLISH_TITLE = "The Harvest (or Harvest in Provence)"
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": "Die Ernte (oder Die Ernte in der Provence)",
    "fr": "La moisson (ou La moisson en Provence)",
    "es": "La cosecha (o El estío en Arlés)",
    "nl": ORIGINAL_TITLE,
    "it": "Il raccolto (o Mietitura in Provenza)",
}
ALT_EN_TITLE = "The Harvest"
