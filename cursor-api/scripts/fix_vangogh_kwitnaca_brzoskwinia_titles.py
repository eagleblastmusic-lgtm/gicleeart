"""Poprawka tytulow: Kwitnace drzewo brzoskwiniowe (Vincent Van Gogh)."""
...
OLD_PL_TITLES = ("Kwitnąca brzoskwinia",)
OLD_EN_TITLES = ("Peach Tree in Blossom",)
OLD_ORIGINAL_TITLES = ("Perzikboom in bloei",)
NEW_PL_TITLE = (
    "Kwitnące drzewo brzoskwiniowe "
    "(lub Kwitnące drzewo migdałowe lub Drzewo brzoskwiniowe w rozkwicie)"
)
ORIGINAL_TITLE = "Bloeiende perzikboom"
ENGLISH_TITLE = (
    "Peach Tree in Blossom "
    "(or Almond Tree in Blossom or Flowering Peach Tree)"
)
