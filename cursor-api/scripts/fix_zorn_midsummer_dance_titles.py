"""Poprawka tytulow: Taniec świętojański (Anders Zorn)."""
...
ARTIST = "Anders Zorn"
OLD_PL_TITLES = ("Midsummer Dance",)
ORIGINAL_TITLE = "Midsommardans"
NEW_PL_TITLE = format_title_alternative_parenthetical(
    "Taniec świętojański (lub Taniec nocy letniej)",
    "pl",
)
ENGLISH_TITLE = "Midsummer Dance"
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": format_title_alternative_parenthetical(
        "Mididsommertanz (oder Mittsommertanz)",
        "de",
    ),
    "fr": format_title_alternative_parenthetical(
        "Danse de la Saint-Jean (ou Danse du solstice d'été)",
        "fr",
    ),
    "es": format_title_alternative_parenthetical(
        "Baile de San Juan (o Danza de la noche de San Juan)",
        "es",
    ),
    "nl": ORIGINAL_TITLE,
