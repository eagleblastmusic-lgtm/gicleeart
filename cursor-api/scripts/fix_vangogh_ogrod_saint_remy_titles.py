"""Poprawka tytulow: Ogrod zakladu psychiatrycznego w Saint-Remy (Vincent Van Gogh)."""
...
OLD_PL_TITLES = ("Ogród szpitala w Saint-Rémy",)
NEW_PL_TITLE = (
...
ORIGINAL_TITLE = "De tuin van de inrichting in Saint-Rémy"
ENGLISH_TITLE = "The Garden of the Asylum at Saint-Rémy (or The Asylum Garden)"
