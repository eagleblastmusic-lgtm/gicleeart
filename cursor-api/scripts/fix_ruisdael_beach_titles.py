"""Poprawka tytulow: Widok plazy w Egmond-aan-Zee (Jacob Van Ruisdael)."""
...
PRODUCT_ID = 15611319550300
ARTIST = "Jacob Van Ruisdael"
OLD_PL_TITLES = (
    "Wybrzeże w Egmond-aan-Zee (lub Widok plaży)",
    "Wybrzeże w Egmond-aan-Zee",
    "Widok plaży",
)
NEW_PL_TITLE = "Widok plaży w Egmond-aan-Zee (lub Brzeg w Egmond an Zee)"
ORIGINAL_TITLE = "Strandgezicht (of Het strand van Egmond-aan-Zee)"
ENGLISH_TITLE = "The Shore at Egmond-aan-Zee (or Beach View)"
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": "Strand von Egmond aan Zee (oder Strandansicht)",
    "fr": "La plage d'Egmond-aan-Zee (ou Vue de plage)",
    "es": "La playa de Egmond-aan-Zee (o Vista de la playa)",
    "nl": ORIGINAL_TITLE,
    "it": "La spiaggia di Egmond-aan-Zee (o Veduta della spiaggia)",
}
ALT_EN_TITLE = "The Shore at Egmond-aan-Zee"
