"""Poprawka tytulow: Jusepe Ribera — Swieta Rodzina (korekta oryginalu i NL)."""
...
OLD_PL_TITLES = (
    ...
    "Święta Rodzina ze świętymi Anną i Katarzyną Aleksandryjską (lub Mistyczne zaślubiny świętej Katarzyny/Święta Rodzina ze św. Anną i Katarzyną Aleksandryjską (z Metropolitan Museum of Art))",
)
NEW_PL_TITLE = (
...
ORIGINAL_TITLE = "La Sagrada Familia con Santa Ana y Santa Catalina de Alejandría"
ALT_EN_TITLE = "The Holy Family with Saints Anne and Catherine of Alexandria"
LOCALE_TITLES = {
    "en": (
    ...
    "es": (
        ...
        "(o Los desposorios místicos de Santa Catalina de Alejandría con la Sagrada Familia)"
    ),
    "nl": (
        "De Heilige Familie met de heiligen Anna en Catharina van Alexandrië "
        "(of Het mystieke huwelijk van de heilige Catharina van Alexandrië "
...
def main() -> int:
    ...
    if not prod.get("id"):
        raise RuntimeError(f"Brak produktu id={PRODUCT_ID}")
