"""Poprawka tytulow: Wzburzone morze w pobliżu brzegu (Jacob Van Ruisdael)."""
...
PRODUCT_ID = 15611320435036
ARTIST = "Jacob Van Ruisdael"
OLD_PL_TITLES = (
    "Widok wybrzeża Norwegii (albo Wzburzone morze)",
    "Widok z wybrzeża Norwegii lub Wzburzone morze w pobliżu brzegu",
    "Widok z wybrzeża Norwegii (lub Wzburzone morze w pobliżu brzegu)",
)
NEW_PL_TITLE = "Wzburzone morze w pobliżu brzegu (lub Widok z wybrzeża Norwegii)"
ORIGINAL_TITLE = "Stormachtige zee bij de kust (of Gezicht na de kust van Noorwegen)"
ENGLISH_TITLE = "A Stormy Sea Near the Coast (or View from the Coast of Norway)"
LOCALE_TITLES: dict[str, str] = {
    "en": ENGLISH_TITLE,
    "de": "Stürmische See nahe der Küste (oder Blick von der Küste Norwegens)",
    "fr": "Mer orageuse près de la côte (ou Vue de la côte de la Norvège)",
    "es": "Mar tormentoso cerca de la costa (o Vista desde la costa de Noruega)",
    "nl": ORIGINAL_TITLE,
    "it": "Mare stormoso vicino alla costa (o Veduta dalla costa della Norvegia)",
}
ALT_EN_TITLE = "A Stormy Sea Near the Coast"
...
def main() -> int:
    ...
    for old in OLD_PL_TITLES:
        if old in pl_body and old not in NEW_PL_TITLE:
