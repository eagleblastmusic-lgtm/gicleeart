...
class WriterSafetyTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.roaming_root = root / "roaming"
        self._env = patch.dict(
            "os.environ",
            {
                "GICLEEAPP_LOCAL_ROOT": str(self.local_root),
                "GICLEEAPP_ROAMING_ROOT": str(self.roaming_root),
            },
        )
        self._env.start()
    ...
    def test_save_variant_changes_only_selected_variant(self) -> None:
        ...
        self.assertEqual(result.backup_path.parent, expected_backup_root)
        self.assertEqual(result.backup_path.read_bytes(), gf1_before)
        self.assertFalse((self.component_dir / "data" / "variant_backups").exists())
    ...
    def test_bounded_apply_writes_only_managed_fields_and_exact_backup(self) -> None:
        ...
        self.assertFalse((self.component_dir / "data" / "apply_backups").exists())
