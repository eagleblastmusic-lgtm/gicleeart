...
def test_theme_registers_basic_and_nocturne_button_styles() -> None:
    ...
    assert settings["current"][service.BUTTON_STYLE_KEY] in {"basic", "nocturne"}
...
def test_button_style_writer_changes_only_the_bounded_setting(
    ...
    assert '+    "giclee_button_style": "nocturne",' in plan.diff_text
    removed = [
    ...
    assert added == ['+    "giclee_button_style": "nocturne",']
    ...
    assert service.load_button_style() == "nocturne"
