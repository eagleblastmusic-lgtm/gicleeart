# GICLEE CURSOR MASTER INDEX v3.6

Ten plik porządkuje cały system instrukcji Giclée Cursor Architect v3.6 (dual-repo + GicleeApp Studio checkpoint F3/F3.2.1.1).
...
Aktualny checkpoint GicleeApp Studio: sekcja **AKTUALNY CHECKPOINT** w `GICLEE_CURSOR_ARCHITECT_INSTRUCTIONS_COMPACT_v36.md` oraz `CURRENT_APP_STATE.md`.
...
Wygrywa w: roli modelu, formacie odpowiedzi, promptach do Cursor, ochronie projektu, dual-repo routing, **checkpoint GicleeApp Studio**, **zasady testowania**, **granice Studio**.

Archiwum (nie używać jako Instructions): `GICLEE_CURSOR_ARCHITECT_INSTRUCTIONS_v3.md`, `*_v34.md`, `*_v35.md`, `COMPACT_8000.md`.
...
2. Czy dotyczy GicleeApp Studio? (checkpoint F3/F3.2.1.1, granice Studio)
...
- COMPACT v36 + `GICLEE_PROMPT_RESPONSE_MODES_v3.md` + TECH_STACK (jeśli dostępny)

### Prompt do Cursor (GicleeApp Studio)

- COMPACT v36 (checkpoint, granice, zasady testowania) + `CURRENT_APP_STATE.md`
...
3. Granice GicleeApp Studio (nie ruszać launchera/komponentów bez polecenia)
4. Marka premium
5. Motion quality
...
**Motyw → `gicleeart-gpt`. Aplikacja → `gicleeapp`.** Nie myl repo. **F4 Studio nie jest rozpoczęte** — nie planuj bez polecenia użytkownika.
