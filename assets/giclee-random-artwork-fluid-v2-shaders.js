/*
 * Losuj Obraz V5 — fluid cursor smoke shaders.
 * Port of Pedzel_Alchemy variant 2 (Elegant).
 */
...
export const bloomFinalFrag = /* glsl */ `
varying vec2 vL;
varying vec2 vR;
varying vec2 vT;
varying vec2 vB;
...
export const sunraysMaskFrag = /* glsl */ `
varying vec2 vUv;
uniform sampler2D uTexture;
